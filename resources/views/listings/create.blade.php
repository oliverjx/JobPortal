    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            >
                ...
                @endguest
                <div class="mb-4 mx-2">
                    <x-label for="title" value="Titulo del trabajo" />
                    <x-input
                        id="title"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="company" value="Compañía" />
                    <x-input
                        id="company"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="logo" value="Logo de la compañía" />
                    <x-input
                        id="logo"
                        class="block mt-1 w-full"
                        type="file"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="location" value="Ubicación (dirección)" />
                    <x-input
                        id="location"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="tags" value="Etiquetas (separadas por comas)" />
                    <x-input
                        id="tags"
                        class="block mt-1 w-full"
                        type="text"
                ...
                <div class="mb-4 mx-2">
                    <x-label for="content" value="Descripción de la oferta" />
                    <textarea
                        id="content"
                        rows="8"
